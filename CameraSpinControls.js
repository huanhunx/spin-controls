...
export var CameraSpinControls = function (camera, domElement, isAutoMoveToFingersCenter = false) {
	...
	function onTouchEnd(event) {
		...
		if (event.touches.length === 0) {
			...
			scope.spinControl.enabled = scope.rotateStatus;
